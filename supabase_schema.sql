...
-- =============================================
-- 13. WebRTC Signals (Sinalização P2P para Sala Virtual)
-- =============================================
...
DROP POLICY IF EXISTS "Public webrtc signals view" ON public.webrtc_signals;
DROP POLICY IF EXISTS "Public webrtc signals insert" ON public.webrtc_signals;
DROP POLICY IF EXISTS "Public webrtc signals delete" ON public.webrtc_signals;

CREATE POLICY "Public webrtc signals view" ON public.webrtc_signals FOR SELECT USING (true);
CREATE POLICY "Public webrtc signals insert" ON public.webrtc_signals FOR INSERT WITH CHECK (true);
...
-- 2. Funci�n RPC para descontar saldo al agendar clases
...
-- 3. Funci�n RPC para que un tutor solicite pagos
